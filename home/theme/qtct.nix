...
in {
  config = lib.mkIf (cfg.gui.enable) {
    xdg.configFile."qt5ct/colors/Penumbra.conf".text = ''
      ...
      #  active_colors=${colors.base.sun},          ${colors.base.shade'}, ${colors.base.shade}, #cbc7c4, #9f9d9a, #b8b5b2, ${colors.base.sun},           #ff0000, ${colors.base.sun_}, ${colors.base.sky_}, ${colors.base.shade}, #767472, ${colors.accent.cyan}, ${colors.base.sun}, ${colors.accent.cyan}, ${colors.base.sun},            ${colors.base.shade}, ${colors.base.sun},           ${colors.base.shade_}, ${colors.base.sun_}
      #disabled_colors=#cbc6bf, ${colors.base.shade'}, ${colors.base.shade}, #cbc7c4, #9f9d9a, #b8b5b2, #d8d2ca,  #ffec17, ${colors.base.sun_}, ${colors.base.sky_}, ${colors.base.shade}, #767472, ${colors.accent.cyan}, ${colors.base.sun}, ${colors.accent.cyan}, #cbc6bf,   ${colors.base.shade}, #cbc6bf,  ${colors.base.shade_}, #beb6a9
